$(document).ready(function () {
    ...
    let order = "";
    let sum = 1;
    let listproduk2 = ["Jet Tempur", "Nuklir Hiroshima", "Infinity Stone", "Burj Khalifa", "Rudal Hipersonik"];
    ...
    $("#button-tambah").on("click", function () {
      ...
      if ($("#total" + sum).val() <= pesanan[total_iterasi].total) {
        ...
        listproduk2.splice(listproduk2.indexOf($("#pesanan" + sum).val()), 1);
        sum++;

        if (listproduk2.length > 0) {
